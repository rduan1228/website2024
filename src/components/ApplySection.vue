...
<template>
    <div class="apply-parent">
        ...
        <div class="apply-time-till" v-if="timeRemaining">
            ...
            <p><div class="apply-time-unit-2">days</div></p>
            <p><div class="apply-time-unit-2">hours</div></p>
            <p><div class="apply-time-unit-2">minutes</div></p>
            <p><div class="apply-time-unit-2">seconds</div></p>
        </div>
